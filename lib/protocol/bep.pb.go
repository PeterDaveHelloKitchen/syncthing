...
func (Compression) EnumDescriptor() ([]byte, []int) { return fileDescriptorBep, []int{0} }
...
func (FileInfoType) EnumDescriptor() ([]byte, []int) { return fileDescriptorBep, []int{1} }
...
func (ErrorCode) EnumDescriptor() ([]byte, []int) { return fileDescriptorBep, []int{2} }
...
type Message struct {
	...
	Compressed       *CompressedMessage `protobuf:"bytes,16,opt,name=compressed" json:"compressed,omitempty"`
}
...
type CompressedMessage struct {
	...
	UncompressedLength int32  `protobuf:"varint,2,opt,name=uncompressed_length,json=uncompressedLength,proto3" json:"uncompressed_length,omitempty"`
}

func (m *CompressedMessage) Reset()                    { *m = CompressedMessage{} }
func (m *CompressedMessage) String() string            { return proto.CompactTextString(m) }
func (*CompressedMessage) ProtoMessage()               {}
func (*CompressedMessage) Descriptor() ([]byte, []int) { return fileDescriptorBep, []int{2} }
...
func init() {
	...
	proto.RegisterType((*CompressedMessage)(nil), "protocol.CompressedMessage")
...
func (m *Message) MarshalTo(data []byte) (int, error) {
	...
	if m.Compressed != nil {
		...
		data[i] = 0x1
		i++
		i = encodeVarintBep(data, i, uint64(m.Compressed.ProtoSize()))
...
func (m *CompressedMessage) Marshal() (data []byte, err error) {
	size := m.ProtoSize()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *CompressedMessage) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Message) ProtoSize() (n int) {
	...
	if m.Compressed != nil {
		l = m.Compressed.ProtoSize()
		n += 2 + l + sovBep(uint64(l))
	}
	return n
}

func (m *CompressedMessage) ProtoSize() (n int) {
	var l int
	_ = l
	l = len(m.Data)
	if l > 0 {
...
func (m *Message) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			if m.Compressed == nil {
				m.Compressed = &CompressedMessage{}
			}
...
func (m *CompressedMessage) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompressedMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompressedMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorBep = []byte{
	...
	,
}
